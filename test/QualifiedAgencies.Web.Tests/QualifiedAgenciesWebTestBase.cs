...
{
    public abstract class QualifiedAgenciesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static QualifiedAgenciesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(QualifiedAgenciesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<QualifiedAgenciesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<QualifiedAgenciesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<QualifiedAgenciesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<QualifiedAgenciesDbContext, Task<T>> func)
        {
            T result;
