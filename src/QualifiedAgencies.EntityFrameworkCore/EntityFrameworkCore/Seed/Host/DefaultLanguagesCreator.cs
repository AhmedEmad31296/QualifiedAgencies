...
namespace QualifiedAgencies.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly QualifiedAgenciesDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = QualifiedAgenciesConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(QualifiedAgenciesDbContext context)
        {
            _context = context;
        }
